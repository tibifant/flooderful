...
lsResult shader_create(_Out_ shader *pShader, const char *vertexSource, const char *fragmentSource);
lsResult shader_createFromFile(_Out_ shader *pShader, const char *vertexPath, const char *fragmentPath);
