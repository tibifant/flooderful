...
lsResult shader_create_internal(shader *pShader, const char *vertexSource, const char *fragmentSource, const bool requestNewProgram);
lsResult shader_allocCleanSource_internal(_In_ const char *source, _Out_ char **ppCleanSource);

//////////////////////////////////////////////////////////////////////////

lsResult shader_create(shader *pShader, const char *vertexSource, const char *fragmentSource)
{
  return shader_create_internal(pShader, vertexSource, fragmentSource, true);
}

lsResult shader_createFromFile(shader *pShader, const char *vertexPath, const char *fragmentPath)
{
  ...
  LS_ERROR_CHECK(shader_create(pShader, vertexSource, fragmentSource));
